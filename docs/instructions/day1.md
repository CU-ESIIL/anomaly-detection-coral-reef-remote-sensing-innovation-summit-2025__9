...
- Add your names to **[Team](https://cu-esiil.github.io/anomaly-detection-coral-reef-remote-sensing-innovation-summit-2025__9/#team)** (top nav → Team) and mirror the details on the dedicated [`docs/team.md`](../team.md) page. Edit the table, keep it simple.
